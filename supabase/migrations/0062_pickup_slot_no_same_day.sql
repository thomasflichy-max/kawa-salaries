-- Run this once in the Supabase SQL Editor, after 0001-0061.
--
-- set_pickup_slot no longer accepts today as a pickup date — only
-- strictly-future weekdays, up to 30 days out. Same-day slots (whether a
-- first choice or a change) gave staff no time to prepare the order;
-- upcomingWeekdays() (lib/pickup-slot.ts) already stopped offering today
-- in the picker, this is the matching server-side guard.
